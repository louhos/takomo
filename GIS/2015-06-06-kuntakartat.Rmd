...
```{r 20150606-mmlplot, warning=FALSE, message=FALSE, fig.height=4, fig.width=6}
...
```{r 20150606-mmlplot2, warning=FALSE, message=FALSE, fig.width=6, fig.height=8}
# Get data frames
df <- sp2df(sp)
...
```{r 20150606-mmlplot2b, warning=FALSE, message=FALSE, fig.width=7, fig.height=8}
